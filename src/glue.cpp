...
namespace
{
	...
	static state_t state = GLUE_STATE_IDLE;
		...
		for (;;)
		{
			...
			case GLUE_STATE_BLE_TO_A2DP_0:
				if (msg == GLUE_MSG_BLE_TO_A2DP_START)
				{
					...
					state = GLUE_STATE_BLE_TO_A2DP_1;
			...
			case GLUE_STATE_BLE_TO_A2DP_1:
				if (msg == GLUE_MSG_BLE_DISCONNECTED)
				{
					...
					state = GLUE_STATE_BLE_TO_A2DP_2;
			...
			case GLUE_STATE_A2DP_TO_A2DP_0:
				if (msg == GLUE_MSG_A2DP_TO_A2DP_START)
				{
					...
					state = GLUE_STATE_A2DP_TO_A2DP_1;
			...
			case GLUE_STATE_A2DP_TO_A2DP_1:
				if (msg == GLUE_MSG_A2DP_MEDIA_STOPPED)
				{
					...
					state = GLUE_STATE_A2DP_TO_A2DP_2;
			...
			case GLUE_STATE_A2DP_TO_A2DP_2:
				if (msg == GLUE_MSG_A2DP_DISCONNECTED)
				{
					...
					state = GLUE_STATE_A2DP_TO_A2DP_3;
			...
			case GLUE_STATE_A2DP_TO_A2DP_3:
				if (msg == GLUE_MSG_A2DP_CONNECTED)
				{
					...
					state = GLUE_STATE_A2DP_TO_A2DP_4;
					esp_ble_gattc_open(
						interface,
						first_addr,
			...
			case GLUE_STATE_A2DP_TO_BLE_0:
				if (msg == GLUE_MSG_A2DP_TO_BLE_START)
				{
					...
					state = GLUE_STATE_A2DP_TO_BLE_1;
					esp_a2d_media_ctrl(ESP_A2D_MEDIA_CTRL_STOP);
				}
				break;
			...
			case GLUE_STATE_A2DP_TO_BLE_1:
				if (msg == GLUE_MSG_A2DP_MEDIA_STOPPED)
				{
					...
					state = GLUE_STATE_A2DP_TO_BLE_2;
					esp_a2d_sink_disconnect(first_addr);
				}
				break;
			...
			case GLUE_STATE_A2DP_TO_BLE_2:
				if (msg == GLUE_MSG_A2DP_DISCONNECTED)
				{
					...
					state = GLUE_STATE_A2DP_TO_BLE_3;
					esp_ble_gattc_open(
						interface,
						first_addr,
						BLE_ADDR_TYPE_PUBLIC,
	...
	{
		static const msg_t msg = GLUE_MSG_BLE_TO_A2DP_START;
	...
	{
		static const msg_t msg = GLUE_MSG_A2DP_TO_A2DP_START;
	...
	{
		static const msg_t msg = GLUE_MSG_A2DP_TO_BLE_START;
...
namespace glue
{
	...
	void ble_to_a2dp(esp_bd_addr_t ble_addr)
	{
		...
		state = GLUE_STATE_BLE_TO_A2DP_0;
	...
	void a2dp_to_a2dp(esp_bd_addr_t old_addr, esp_bd_addr_t new_addr)
	{
		...
		state = GLUE_STATE_A2DP_TO_A2DP_0;
	...
	void a2dp_to_ble(esp_bd_addr_t addr)
	{
		...
		state = GLUE_STATE_A2DP_TO_BLE_0;
		notify_a2dp_to_ble_start();
	}

	void notify_ble_connected()
	{
		static const msg_t msg = GLUE_MSG_BLE_CONNECTED;
	...
	{
		static const msg_t msg = GLUE_MSG_BLE_DISCONNECTED;
	...
	{
		static const msg_t msg = GLUE_MSG_A2DP_CONNECTED;
	...
	{
		static const msg_t msg = GLUE_MSG_A2DP_MEDIA_STOPPED;
	...
	{
		static const msg_t msg = GLUE_MSG_A2DP_DISCONNECTING;
	...
	{
		static const msg_t msg = GLUE_MSG_A2DP_DISCONNECTED;
